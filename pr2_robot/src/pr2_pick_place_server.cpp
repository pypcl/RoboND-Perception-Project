    ...
    left_gripper_group(LEFT_GRIPPER_GROUP)
{
  ...
  right_success = static_cast<bool>(right_move_group.move());
                    ...
                    pr2_robot::PickPlace::Response &res)
{
  ...
  else
  {
    ...
    if(req.arm_name.data == "right")
    {
      ...
      right_success = static_cast<bool>(right_move_group.plan(right_arm_plan));
    ...
    else
    {
      ...
      left_success = static_cast<bool>(left_move_group.plan(left_arm_plan));
      ROS_INFO("Visualizing plan to target: %s",
...
bool PR2PickPlace::OperateRightGripper(const bool &close_gripper)
{
  ...
  bool success = static_cast<bool>(right_gripper_group.move());
  return success;
}
...
bool PR2PickPlace::OperateLeftGripper(const bool &close_gripper)
{
  ...
  bool success = static_cast<bool>(left_gripper_group.move());
  return success;
}
